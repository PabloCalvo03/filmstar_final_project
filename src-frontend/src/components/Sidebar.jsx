      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-200 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <ProfilePreview
                avatar="https://lh3.googleusercontent.com/ogw/AF2bZyjV44vUFxlNxI9TqNG7hPUHbsfFS7KrnUwFRt4kMpIIkP2z=s64-c-mo"
              ></ProfilePreview>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Invite friend</span>
              </a>
            </li>
            <li>
              <a
